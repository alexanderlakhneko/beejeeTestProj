        ...
        public function countOwn($type)
        {
            ...
            if ($this->getID()) {
                ...
                if (!self::$useFluidCount) {
                    $count = $this->beanHelper->getToolbox()->getWriter()->queryRecordCount($type, [], $sql, $bindings);
                } else {
...
namespace RedBeanPHP {
    ...
    interface QueryWriter
    {
         ...
         * @return array
         */
        public function queryRecursiveCommonTableExpression($type, $id, $up = true, $addSql = NULL, $bindings = [], $select = QueryWriter::C_CTE_SELECT_NORMAL);
...
namespace RedBeanPHP\QueryWriter {
    ...
    abstract class AQueryWriter
    {
         ...
         */
        public function writeJoin($type, $targetType, $leftRight = 'LEFT', $joinType = 'parent', $firstOfChain = true, $suffix = '', $aliases = [], $cteType = NULL)
        {
            ...
            if ($joinType == 'shared') {
                ...
                if (isset($globalAliases[$type])) {
                    ...
                    if ($aliases && count($aliases) === 1) {
                        ...
                        $assocTable = $this->getAssocTable([$cteType ? $cteType : $globalAliases[$type], $destType]);
                    }
                } else {
                    ...
                    if ($aliases && count($aliases) === 1) {
                        ...
                        $assocTable = $this->getAssocTable([$cteType ? $cteType : $type, $destType]);
                    }
                }
         ...
         */
        public function queryRecursiveCommonTableExpression($type, $id, $up = true, $addSql = NULL, $bindings = [], $selectForm = false)
        {
...
namespace RedBeanPHP {
    ...
    class Finder
    {
         ...
         * @return OODBBean
         */
        public function findOrCreate($type, $like = [], $sql = '', &$hasBeenCreated = false)
        {
            $sql   = $this->toolbox->getWriter()->glueLimitOne($sql);
    ...
    class AssociationManager extends Observable
    {
        ...
        public function related($bean, $type, $sql = '', $bindings = [])
        {
            ...
            foreach ($rows as $key => $row) {
                if (!isset($links[$row['id']])) $links[$row['id']] = [];
...
namespace RedBeanPHP {
    ...
    class Facade
    {
         ...
         * @return ToolBox
         */
        public static function setup($dsn = NULL, $username = NULL, $password = NULL, $frozen = false, $partialBeans = false, $options = [])
        {
            if (is_null($dsn)) {
         ...
         * @return void
         */
        public static function addDatabase($key, $dsn, $user = NULL, $pass = NULL, $frozen = false, $partialBeans = false, $options = [])
        {
         ...
         * @return ToolBox
         */
        public static function createToolbox($dsn = NULL, $username = NULL, $password = NULL, $frozen = false, $partialBeans = false, $options = [])
        {
            if (is_object($dsn)) {
                $db     = new RPDO($dsn);
         ...
         * @return array
         */
        public static function findOneForUpdate($type, $sql = NULL, $bindings = [])
        {
         ...
         * @return array
         */
        public static function exportAll($beans, $parents = false, $filters = [], $meta = false)
        {
         ...
         * @return array
         */
        public static function findFromSQL($type, $sql, $bindings = [], $metamask = 'extra_', $autoExtract = false)
        {
        ...
        public static function loadJoined($beans, $type, $sqlTemplate = 'SELECT %s.* FROM %s WHERE id IN (%s)')
        {
            ...
            $result = self::findMulti($type, self::genSlots($beans, sprintf($sqlTemplate, $type, $type, '%s')), $ids, [Finder::onmap($type, $beans)]);
            $bean   = reset($beans);
         ...
         * @return OODBBean
         */
        public static function findOrCreate($type, $like = [], $sql = '', &$hasBeenCreated = false)
        {
         ...
         */
        public static function countChildren(OODBBean $bean, $sql = NULL, $bindings = [], $select = QueryWriter::C_CTE_SELECT_COUNT)
        {
         ...
         * @param string|boolean $select select snippet to use (advanced, optional, see QueryWriter::queryRecursiveCommonTableExpression)
         */
        public static function countParents(OODBBean $bean, $sql = NULL, $bindings = [], $select = QueryWriter::C_CTE_SELECT_COUNT)
        {
...
namespace RedBeanPHP {
    ...
    class DuplicationManager
    {
         ...
         * @return array
         */
        public function exportAll($beans, $parents = false, $filters = [], $caseStyle = 'snake', $meta = false)
        {
            $array = [];
            if (!is_array($beans)) {
                $beans = [$beans];
...
namespace RedBeanPHP\Util {
    ...
    class Tree
    {
         ...
         * @return integer
         */
        public function countChildren(OODBBean $bean, $sql = NULL, $bindings = [], $select = true)
        {
            $type  = $bean->getMeta('type');
            $id    = $bean->id;
         ...
         * @return integer
         */
        public function countParents(OODBBean $bean, $sql = NULL, $bindings = [], $select = true)
        {
            $type  = $bean->getMeta('type');
            $id    = $bean->id;
